...
var fileClassificationCases = []fileCase{
	{name: "no-op", kind: KindFile, source: sourceA, target: sourceA, mode: 0o644,
		...
		want:     FileClassification{TargetPath: "a.conf", Action: ActionNoOp, Reason: ReasonNoChange, Convergence: Converged}},
	{name: "mode correction", kind: KindFile, source: sourceA, target: sourceA, mode: 0o644, exec: 0o100,
		baseline: stateAt(sourceA, sourceA, 0),
		want:     FileClassification{TargetPath: "a.conf", Action: ActionCorrectMode, Reason: ReasonModeCorrection, Convergence: ActionPending}},
	...
	{name: "source-only change", kind: KindFile, source: sourceB, target: sourceA, mode: 0o644,
		baseline: stateAt(sourceA, sourceA, 0),
		want:     FileClassification{TargetPath: "a.conf", Action: ActionWriteSourceToTarget, Reason: ReasonSourceChanged, Convergence: ActionPending}},
	{name: "target-only drift", kind: KindFile, source: sourceA, target: targetX, mode: 0o644,
		baseline: stateAt(sourceA, sourceA, 0),
		want:     FileClassification{TargetPath: "a.conf", Action: ActionNeedsDecision, Reason: ReasonTargetDrift, Convergence: DecisionRequired}},
	{name: "both changed converged", kind: KindFile, source: sourceB, target: sourceB, mode: 0o644,
		baseline: stateAt(sourceA, sourceA, 0),
		want:     FileClassification{TargetPath: "a.conf", Action: ActionEstablishBaseline, Reason: ReasonAlreadyConverged, Convergence: Converged}},
	{name: "conflict", kind: KindFile, source: sourceB, target: targetX, mode: 0o644,
		baseline: stateAt(sourceA, sourceA, 0),
		want:     FileClassification{TargetPath: "a.conf", Action: ActionNeedsDecision, Reason: ReasonConflict, Convergence: DecisionRequired}},
	...
	{name: "database loss create", source: sourceA, kind: KindAbsent,
		want: FileClassification{TargetPath: "a.conf", Action: ActionCreateTarget, Reason: ReasonUnbaselinedAbsent, Convergence: ActionPending}},
	{name: "database loss adopt", kind: KindFile, source: sourceA, target: sourceA, mode: 0o644,
		want: FileClassification{TargetPath: "a.conf", Action: ActionEstablishBaseline, Reason: ReasonUnbaselinedEqual, Convergence: Converged}},
	...
	{name: "database loss differ", kind: KindFile, source: sourceA, target: targetX, mode: 0o644,
		want: FileClassification{TargetPath: "a.conf", Action: ActionNeedsDecision, Reason: ReasonUnbaselinedDiffer, Convergence: DecisionRequired}},
	...
	{name: "symlink drift", source: sourceA, kind: KindSymlink,
		baseline: stateAt(sourceA, sourceA, 0),
		want:     FileClassification{TargetPath: "a.conf", Action: ActionNeedsDecision, Reason: ReasonUnexpectedTargetType, Convergence: DecisionRequired}},
	{name: "symlink unbaselined", source: sourceA, kind: KindSymlink,
		want: FileClassification{TargetPath: "a.conf", Action: ActionNeedsDecision, Reason: ReasonUnexpectedTargetType, Convergence: DecisionRequired}},
	{name: "directory target", source: sourceA, kind: KindDirectory,
		baseline: stateAt(sourceA, sourceA, 0),
		want:     FileClassification{TargetPath: "a.conf", Action: ActionNeedsDecision, Reason: ReasonUnexpectedTargetType, Convergence: Rejected}},
